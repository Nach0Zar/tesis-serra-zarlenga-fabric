...
- [Contrato público del chaincode](../api-contract.md) (v2.5.0): `QueryUnitsByGTIN` por clave compuesta parcial (sin rich queries), `RegisterOrganization` para el seed del registro, `Init` para el bootstrap regulatorio, y `AuthorizeLabIntervention`/`RevokeLabIntervention` para los puntos 6.e y 6.f.
