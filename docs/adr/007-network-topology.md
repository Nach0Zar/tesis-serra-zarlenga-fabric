...
- [Contrato público del chaincode](../api-contract.md) (v2.3.0): `QueryUnitsByGTIN` por clave compuesta parcial (sin rich queries), `RegisterOrganization` para el seed del registro, `Init` para el bootstrap regulatorio y `AuthorizeLabIntervention` para el punto 6.f.
