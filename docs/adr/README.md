...
| [`012-baseline-design.md`](012-baseline-design.md) | Aceptado | ADR-012: baseline centralizada en Go + PostgreSQL con paquete compartido; checklist normativo de paridad funcional. |
