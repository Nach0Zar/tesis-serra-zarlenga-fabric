...
- `DEVOLVER_PRODUCTO` registra el hecho normativo de la devolución en una sola transacción; `CustodioActual` no cambia; el receptor de la devolución puede declararse como dato del registro de la operación en PDC, informativo y auditable.
